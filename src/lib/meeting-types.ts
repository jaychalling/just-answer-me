...
export const SPEAKERS: Record<string, Speaker> = {
  ...
  '수익화전문가': { emoji: '💰', name: '수익화전문가', color: 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30' },
  '수익화 전문가': { emoji: '💰', name: '수익화 전문가', color: 'bg-emerald-500/20 text-emerald-400 border-emerald-500/30' },
  '수학자': { emoji: '🔢', name: '수학자', color: 'bg-cyan-500/20 text-cyan-400 border-cyan-500/30' },
  '시장조사원': { emoji: '🔍', name: '시장조사원', color: 'bg-indigo-500/20 text-indigo-400 border-indigo-500/30' },
  ...
  '아키텍트': { emoji: '🏗️', name: '아키텍트', color: 'bg-orange-500/20 text-orange-400 border-orange-500/30' },
  '채찍맨': { emoji: '🔨', name: '채찍맨', color: 'bg-red-500/20 text-red-400 border-red-500/30' },
  '보안관': { emoji: '🛡️', name: '보안관', color: 'bg-gray-500/20 text-gray-400 border-gray-500/30' },
  '그로스해커': { emoji: '📈', name: '그로스해커', color: 'bg-green-500/20 text-green-400 border-green-500/30' },
  ...
  '경제분석가': { emoji: '📊', name: '경제분석가', color: 'bg-teal-500/20 text-teal-400 border-teal-500/30' },
