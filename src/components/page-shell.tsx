...
import { ArrowLeft, FileText, ClipboardList, Code, CheckCircle, Calendar, Tag, Users, Layers } from 'lucide-react'

interface PageShellProps {
  projectId: string
  projectTitle: string
  subtitle: string
  activeTab: 'main' | 'minutes' | 'docs' | 'report'
  date?: string
...
const tabConfig = {
  main: { label: '기획서', icon: FileText },
  minutes: { label: '회의록', icon: ClipboardList },
  docs: { label: 'Docs', icon: Code },
  report: { label: '완료보고', icon: CheckCircle },
} as const
...
export function PageShell({
  ...
  const tabs: (keyof typeof tabConfig)[] = ['main', 'minutes', 'docs', ...(hasReport ? ['report' as const] : [])]
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="hidden sm:inline">Idea Hub</span>
            </Link>
